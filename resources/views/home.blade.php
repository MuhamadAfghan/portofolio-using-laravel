                ...
                <div class="col-xxl-5">
                    ...
                    <div class="text-center text-xxl-start">
                        <div class="badge bg-gradient-primary-to-secondary text-white mb-4">
                            <div class="text-uppercase">Development &middot; Backend</div>
                        </div>
                        <h1 class="display-3 fw-bolder mb-3"><span class="text-gradient d-inline">Muhamad Afghan Alzena</span>
                        </h1>
                        <div class="d-grid gap-3 d-sm-flex justify-content-sm-center justify-content-xxl-start mb-3">
                            <a class="btn btn-primary btn-lg px-5 py-3 me-sm-3 fs-6 fw-bolder"
                                href="/education">Education</a>
                            <a class="btn btn-outline-dark btn-lg px-5 py-3 fs-6 fw-bolder" href="/portofolio">Portfolio</a>
                        </div>
                    </div>
                </div>
                <div class="col-xxl-7">
            ...
            <div class="row gx-5 justify-content-center">
                <div class="col-xxl-8">
                    <div class="text-center my-5">
                        ...
                        <p class="text-muted">
                            Saya seorang programmer muda yang sedang belajar di SMK Wikrama Bogor. Saya
                            sudah belajar bahasa pemrograman PHP, HTML, CSS, JavaScript, framework Laravel, AJAX, dan
                            Bootstrap, dan memakai database
                            MySQL. Saya memiliki tekad dan semangat tinggi untuk menjadi programmer
                            yang handal dan profesional, serta ingin terus belajar dan berkembang di bidang ini. Saya selalu
                            mencari cara untuk meningkatkan kemampuan dan pengetahuan, sehingga saya dapat memberikan
                            kontribusi maksimal bagi tim Anda
                        </p>
                        <div class="d-flex justify-content-center fs-2 gap-4">
                            <a class="text-gradient" href="https://wa.me/6283808383191"><i class="bi bi-whatsapp"></i></a>
                            <a class="text-gradient" href="https://www.linkedin.com/in/MuhamadAfghan"><i
                                    class="bi bi-linkedin"></i></a>
                            <a class="text-gradient" href="https://github.com/MuhamadAfghan"><i
